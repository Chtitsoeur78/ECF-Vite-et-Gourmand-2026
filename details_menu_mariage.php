  ...
  <body>
    ...
    <figure>
        ...
        <figcaption>Une autre découverte pour terminer le repas ? Le millas charentais, gâteau à base de farine de maïs à la texture fondante.  </figcaption>
            ...
            <p>Contrairement aux autres menus proposés, le menu "Mariage" est composé de deux entrées, un plat principal et deux desserts. </p>
              <h4>Entrées </h4>
                <ul>
            ...
            <p>Les allergènes :  </p>
                <ul>
                    <li>gluten (farine de blé) : Foie gras avec chutney de figue et pain d'épices (pain d'épices), Profiterolles au chocolat noir truffées aux airelles< (pâte à choux), Pièce-montée de choux et nougatine (pâte à chux)</li>
                    <li>oeufs :Foie gras avec chutney de figue et pain d'épices (pain d'épices), Profiterolles au chocolat noir truffées aux airelles< (pâte à choux),Pièce-montée de choux et nougatine (pâte à chux)</li>
                    <li>lait :Foie gras avec chutney de figue et pain d'épices (pain d'épices), Profiterolles au chocolat noir truffées aux airelles< (pâte à choux), Pièce-montée de choux et nougatine (pâte à chux)</li>
                    <li>Crustacés : Homard rôti à la citronelle </li>
                    <li>fruits à coque : Pièce-montée de choux et nougatine (nougatine : amandes)</li>
                </ul>
            ...
            <p>Conditions particulières : La commande du menu "Mariage" doit être effectuée un mois avant la date de livraison.  </p>
