  ...
  <body>
    ...
    <main>
        <section class="details_menus">
              <h2>Ce mois-ci :  Menu "Table maraichère"</h2>
    ...
    <div class="galerie">
      ...
      <figure>
        ...
        <p>Thème : Repas classique</p>
          <h3>La liste des plats du menu :</h3>
              <h4>Entrées</h4>
                <ul>
              ...
              <p>Les allergènes :</p>
                <ul>
                    <li>fruits à coque :  Bûche citron au préliné (praliné : noisettes et/ou amandes).</li>
                    ...
                    <li>lait : Salade de concombres au yaourt (yaourt), Poires farcies au Gorgonzola (gorgonzola), Pain perdu à la sauce caramel, Bûche citron au praliné.</li>
                </ul>
